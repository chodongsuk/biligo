 ...
 */
public class Event3Data extends BaseData {
    private Context mContext;
    private String URL = Config.URL + Config.URL_XML + Config.EVENT3;
    ...
    public Event3Data(Context context) {
        mContext = context;
    }
                ...
                if (result.matches("success")) {
                    ...
                    for (int i = 0; i < jsonArray1.length(); i++) {
                        ...
                        if (mData.size() > 0) {
                            ...
                            mEventHandler.setEd_total(jsonArray1.getJSONObject(i).getString("ed_total"));
