...
import kr.ds.data.Event2SaveData;
 ...
 */
public class Event2ViewActivity extends BaseActivity implements View.OnClickListener{
...
//                    mHashMap.put("efr_end_date", mEditTextEndDate.getText().toString());
                    ...
                    if (mHashMap != null) {
                        new Event2SaveData(getApplicationContext()).clear().setCallBack(new BaseResultListener() {
