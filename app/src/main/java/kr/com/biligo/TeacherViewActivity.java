 ...
 */
public class TeacherViewActivity extends BaseActivity implements View.OnClickListener{
        ...
        switch (v.getId()){
            case R.id.button:
                if(Check()){
                    ...
                    if (mHashMap != null) {
                        new TeacherSaveData(getApplicationContext()).clear().setCallBack(new BaseResultListener() {
                            @Override
            ...
            case R.id.imageView_banner:
                ...
                NextIntent.putExtra("title", "강사 빌리고 신청방법");
                NextIntent.putExtra("url", "http://blog.naver.com/kiminhan4909/220948995942");
