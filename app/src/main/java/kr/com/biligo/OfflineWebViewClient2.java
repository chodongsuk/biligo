 ...
 */
public class OfflineWebViewClient2 extends WebViewClient {

    private Activity mActivity;
    public OfflineWebViewClient2(Activity activity){
        mActivity = activity;
    }
    ...
    public void onPageStarted(WebView view, String url, Bitmap favicon) {
        ...
        ((WebActivity2)mActivity).showProgress();
    }

    @Override
    public void onPageFinished(WebView view, String url) {
        super.onPageFinished(view, url);
        ((WebActivity2)mActivity).showWebView();
        ((WebActivity2)mActivity).hideProgress();
    }
}
