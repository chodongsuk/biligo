...
import kr.ds.data.Event3SaveData;
 ...
 */
public class Event3ViewActivity extends BaseActivity implements View.OnClickListener{
...
//                    mHashMap.put("efr_end_date", mEditTextEndDate.getText().toString());
                    ...
                    if (mHashMap != null) {
                        new Event3SaveData(getApplicationContext()).clear().setCallBack(new BaseResultListener() {
